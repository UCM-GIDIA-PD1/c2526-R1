...
from modelos_utils import download_model_dfs, preprocess_tfidf, preprocess_bag_of_words, build_preprocess_word2vec 
...
def entramiento_modelo_knn_generos(): 
    ...
    for train_idx, val_idx in tqdm(kf.split(X_train)):
        ...
        preprocess = build_preprocess_word2vec(model) #preprocess_tfidf
